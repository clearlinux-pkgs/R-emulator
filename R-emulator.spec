...
Version  : 1.2.17
Release  : 3
URL      : https://cran.r-project.org/src/contrib/emulator_1.2-17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/emulator_1.2-17.tar.gz
...
Allows one to estimate the output of a computer program,
 ...
 from previous runs and a user-specified prior linear model.  A vignette is
 provided and the help pages include examples.
...
export LANG=C
export SOURCE_DATE_EPOCH=1530465506
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library emulator|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
